    ...
    <div class="px-4 py-4 mx-auto max-w-7xl lg:py-6 md:px-6">
      <div class="flex flex-wrap mb-24 -mx-3">
        ...
        <div class="w-full px-3 lg:w-3/4">
          ...
          <div class="px-3 mb-4">
            <div class="items-center justify-between px-4 py-4 bg-gray-100 md:flex dark:bg-gray-900 rounded-md shadow-sm border border-gray-200 dark:border-gray-700">
              ...
              <div class="flex items-center justify-end md:justify-between">
                <select wire:model.live="sort" class="block w-40 text-base bg-white dark:bg-gray-800 cursor-pointer dark:text-gray-400 border border-gray-300 dark:border-gray-700 rounded-md px-3 py-2">
